...
<style>
  label {
    ...
    border-radius: 3.5vw;
    box-shadow:
      inset 0px 3px 9px rgba(0, 0, 0, 0.4),
      inset 0px -3px 9px rgba(255, 255, 255, 0.2);
    cursor: pointer;
    transition: 600ms;
    z-index: 99999;
  }
  ...
  input:checked + label {
    ...
    box-shadow:
      inset 0px 3px 9px rgba(0, 0, 0, 1),
      inset 0px -3px 9px rgba(255, 255, 255, 0.15);
  }

  input:checked + label:after {
    left: 6.43125vw;
    transform: translateX(-100%);
    background: linear-gradient(180deg, #222222, var(--bg-color));
  }
