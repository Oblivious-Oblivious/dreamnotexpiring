<script>
  ...
  onMount(() => {
    ...
    gsap.utils.toArray(".parallax-card").forEach((card) => {
      ...
      const text_reveal = gsap.to(
        `.${card.classList[1].toString()} .parallax-title`,
        {
          paused: true,
          autoAlpha: 1,
          ease: "power2.inOut",
...
<div class="djing-parallax-wrapper" style="visibility: hidden;">
  <div class="parallax-card parallax-genre-river">
    <a
      href="https://www.mixcloud.com/itsoblivious/genre-river/"
      target="_blank"
  ...
  <div class="parallax-card parallax-charmer">
    <a
      href="https://www.mixcloud.com/itsoblivious/charmer/"
      target="_blank"
      rel="noopener noreferrer"
      draggable="false"
    >
  ...
  <div class="parallax-card parallax-future-house-sessions">
    <a
      href="https://www.mixcloud.com/itsoblivious/future-house-sessions-1/"
      target="_blank"
      rel="noopener noreferrer"
      draggable="false"
    >
      <img
        src="/img/future-house-sessions-1.jpg"
        alt="Future House Sessions 1"
        draggable="false"
      />
  ...
  <div class="parallax-card parallax-waiting-for-summer">
    <a
      href="https://www.mixcloud.com/itsoblivious/waiting-for-summer-mix/"
      target="_blank"
      rel="noopener noreferrer"
      draggable="false"
    >
      <img
        src="/img/waiting-for-summer.jpg"
        alt="Waiting For Summer"
        draggable="false"
      />
...
<style>
  ...
  .parallax-genre-river img {
    box-shadow:
      0 0 3.5vw 1.1vw var(--lapis),
      var(--neumorphic-shadow2);
  }
  .parallax-charmer img {
    box-shadow:
      0 0 3.5vw 1.1vw var(--gold),
      var(--neumorphic-shadow2);
  }
  .parallax-future-house-sessions img {
    box-shadow:
      0 0 3.5vw 1.1vw var(--teal),
      var(--neumorphic-shadow2);
  }
  .parallax-waiting-for-summer img {
    box-shadow:
      0 0 3.5vw 1.1vw var(--orange),
      var(--neumorphic-shadow2);
  }
