...
<div class="computer-related-topics-i-enjoy" style="visibility: hidden;">
  <div class="topic topic-pentesting">
    ...
    <code>
      ...
      &nbsp;&nbsp;&nbsp;<span class="topic-code-blue">"</span><span
        class="topic-code-green">\x56\x5a\x56\x48\xbf\x2f\x62\x69\x6e\x2f</span
      ><br />
      &nbsp;&nbsp;&nbsp;&nbsp;<span class="topic-code-green"
        >\x2f\x73\x68\x57\x54\x5f\xb0\x3b\x0f\x05</span
  ...
  <div class="topic topic-oop">
    ...
    <code>
      ...
      & (<span class="topic-code-cyan">nil</span> is_nil?) if_false: -&gt;
      &lbrace; <span class="topic-code-cyan">self</span> halt &rbrace;,<br />
      &nbsp;&nbsp;&nbsp;&nbsp;y = <span class="topic-code-cyan">self</span> size
      + <span class="topic-code-cyan">super</span> size,<br />
      &nbsp;&nbsp;&nbsp;&nbsp;[<span class="topic-code-green">'</span><span
        class="topic-code-blue">a</span
      ><span class="topic-code-green">'</span>,
      <span class="topic-code-green">"</span><span class="topic-code-blue"
        >a</span
      ><span class="topic-code-green">"</span>,
      <span class="topic-code-green">1</span>,
      <span class="topic-code-green">1.0</span>, &lbrace;"k1":
      <span class="topic-code-green">42</span>, k2:
      <span class="topic-code-green">43</span>&rbrace;] each: -&gt; &lbrace;
      elem | (<br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;elem class name puts,<br
      />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
        class="topic-code-green">"</span
      > <span class="topic-code-green">"</span> puts<br />
      &nbsp;&nbsp;&nbsp;&nbsp;)&rbrace;,<br />
      &nbsp;&nbsp;&nbsp;&nbsp;x &lt; y<br />
      )<br />
    </code>
